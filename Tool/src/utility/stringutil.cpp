...
QMap<int, QString> stringUtil::map;
stringUtil::stringUtil()
{
}

QStringList stringUtil::setCodecForReadFile(const QString& fileName, const QString& codec)
{
    QStringList texts;
    QFile file(fileName);
...
QStringList stringUtil::dealVCardRecord(const QString &record)
{
    QStringList fields;
    QString tmp;
...
void stringUtil::splitStringByWord(const QString &value, const QStringList& words, bool order)
{
    QStringList keys;
    QStringList values;
...
QStringList stringUtil::splitByChar(const QString &line, const QChar &ch)
{
...
QString &stringUtil::encode_quote_qprintable(const QByteArray &input)
{
...
QByteArray &stringUtil::decode_quote_qprintable(const QString &input)
{
...
QString stringUtil::unicodeToChinese(const QString &unicode)
{
    return unicode.fromUtf8(unicode.toStdString().c_str());
}

void stringUtil::initPinyinMap()
{
...
QString stringUtil::getPinyinString(QString in)
{
    QString str = in;
    QChar *data = str.data();
...
QString stringUtil::convert(QString str)
{
    QString result ="";
...
QList<QChar> stringUtil::getAllContactNameGroups()
{
    QList<QChar> groups;
...
QChar stringUtil::getPinyinChar(QString in)
{
    if(in.isNull()||in=="")
        return QChar('#');
...
QString stringUtil::getNumFromPinyin(QString str)
{
